...
// Решение конфликта имен Dice (структура) и Dice (пространство имен)
...
namespace CasinoApp.Games.Dice
{
    public class DiceGame : CasinoGameBase
    {
        ...
        private void OnComputerRollInvoke(string v)
        {
            throw new NotImplementedException();
        }

        private void OnPlayerRollInvoke(string v)
        {
            throw new NotImplementedException();
        }
        ...
        /// Теперь кости перекидываются при каждом вызове.
        /// </summary>
        ...
        private void UpdateProfileOnLoose(string message)
        {
            ...
            // Здесь просто выводим результат проигрыша.
        ...
        private void UpdateProfileOnDraw(string message)
        {
            ...
            // Баланс увеличивается на сумму ставки.
            _player.Balance += _bet;
